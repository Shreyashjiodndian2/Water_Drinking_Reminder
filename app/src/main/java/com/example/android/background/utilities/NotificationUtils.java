...
public class NotificationUtils {
    ...
    private static final int ACTION_INCREMENT_NOTIFICATION_ID = 1334;
    private static final int ACTION_DISMISS_ID = 1335;
    ...
    public static NotificationCompat.Action ignoreReminderAction(Context context){
        ...
        PendingIntent pendingIntent = PendingIntent.getService(context,ACTION_DISMISS_ID, intent,PendingIntent.FLAG_CANCEL_CURRENT);
        NotificationCompat.Action action = new NotificationCompat.Action(R.drawable.ic_drink_notification,
                context.getString(R.string.dismiss_notification_title),
                pendingIntent);
        return action;
    }
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context){
        ...
        PendingIntent pendingIntent = PendingIntent.getService(context,ACTION_INCREMENT_NOTIFICATION_ID,
                intent,
                PendingIntent.FLAG_UPDATE_CURRENT);
        NotificationCompat.Action action = new NotificationCompat.Action(R.drawable.ic_drink_notification,
                context.getString(R.string.water_increment_content_desc),
                pendingIntent);
        return action;
    }
